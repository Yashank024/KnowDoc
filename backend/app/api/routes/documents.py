...
def delete_document(doc_id: str):
    """
    Deletes the document registry from documents metadata list and ChromaDB vector chunks.
    """
    logger.info(f"Deleting document registry and chunks for ID: {doc_id}")
    try:
