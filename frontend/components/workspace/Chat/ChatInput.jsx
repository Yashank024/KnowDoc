...
export default function ChatInput({
  ...
  const placeholderText = isGenerating
    ? "KnowDoc is thinking..."
    : isBottom
      ? "Ask questions or search context..."
      : "Ask questions or index documents to search context...";

  return (
    <div className={isBottom ? styles.inputWrapper : styles.centerInputContainer}>
      <form onSubmit={onSubmit} className={styles.centerInputForm}>
        <textarea
          ...
          rows={isBottom ? 1 : 3}
          style={{ minHeight: isBottom ? "38px" : "72px" }}
        />
        ...
        <div className={styles.centerInputFooter}>
          ...
          <div className={styles.centerFooterRight}>
            ...
            <div className={styles.modelSelectorPill} title="Active model via OpenRouter">
              <span>Hunyuan 3</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
      ...
      {isBottom && (
        <p className={styles.inputHint}>
          Connected to OpenRouter with Tencent Hunyuan 3. RAG citations sync automatically.
        </p>
      )}
    </div>
  );
