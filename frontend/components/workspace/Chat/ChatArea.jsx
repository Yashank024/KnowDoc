...
export default function ChatArea({
  ...
  async function handleSend(e) {
    ...
    try {
      await streamAIChatResponse(userText, documents, activeChatMessages, chatId, sessionId, (chunk) => {
        onSendMessage({ id: aiMessageId, sender: "ai", text: chunk, isStreaming: true });
      });
      onSendMessage({ id: aiMessageId, sender: "ai", text: null, isStreaming: false });
    } catch (err) {
      console.error(err);
      onSendMessage({
        id: aiMessageId,
