...
export default function AccountSection({ isCollapsed }) {
  ...
  return (
    <div className={`${styles.accountSection} ${isCollapsed ? styles.accountSectionCollapsed : ""}`}>
      <div className={styles.profileInfo}>
        <div className={styles.avatar} title="Yashank (AI Architect)">Y</div>
        {!isCollapsed && (
          <div className={styles.profileMeta}>
            <span className={styles.userName}>Yashank</span>
            <span className={styles.userRole}>AI Architect</span>
          </div>
        )}
      </div>
